...
```mermaid
graph TD
  N0[a Task] --> N1[b Trajectory]
  N1[b Trajectory] --> N2[c Evaluation]
  N2[c Evaluation] --> N3[d Reflection]
  N3[d Reflection] --> N4[e Next Trajectory]
  N5[1. Decision making] --> N6[You are in the middle of a room ... Task: clean some pan and put it in countertop.]
  N7[2. Programming] --> N8[Task: You are given a list of two strings ... of open or close parentheses only ...]
  N9[3. Reasoning] --> N10[Task: What profession does John Lanchester and Alan Dean Foster have in common?]
  N11[... Action: take pan1 from stoveburner1 Obs: Nothing happens. ... Action: clean pan1 with sinkbasin1 Obs: Nothing happens.] --> N12[def match_parens lst : if s1.count + s2.count == s1.count + s2.count ... return No]
  N13[Think: ... novelist, journalist, critic ... novelist, screenwriter ... common is novelist and screenwriter. Action: novelist, screenwriter] --> N14[Environment Binary Reward: 0]
  N15[... tried to pick up the pan in stoveburner 1 ... but the pan was not in stoveburner 1. ...] --> N16[... wrong because it only checks if the total count of open and close parentheses is equal ... order of the parentheses ...]
  N16[... wrong because it only checks if the total count of open and close parentheses is equal ... order of the parentheses ...] --> N17[... failed because I incorrectly assumed that they both had the same multiple professions ... accurately identifying their professions.]
  N18[... Action: take pan 1 from stoveburner 2 Obs: You put the pan 1 in countertop 1.] --> N19[... return Yes if check S1 or check S2 else No]
  N19[... return Yes if check S1 or check S2 else No] --> N20[Think: ... So the profession John Lanchester and Alan Dean Foster have in common is novelist. Action: novelist]
```

| Related work on reasoning and decision-making<br/>Approach | Related work on reasoning and decision-making<br/>Self refine | Related work on reasoning and decision-making<br/>Hidden constraints | Related work on reasoning and decision-making<br/>Decision making | Related work on reasoning and decision-making<br/>Binary reward | Related work on reasoning and decision-making<br/>Memory |
| ---------------------------------------------------------- | ------------------------------------------------------------- | -------------------------------------------------------------------- | ----------------------------------------------------------------- | --------------------------------------------------------------- | -------------------------------------------------------- |
| Self-refine \[15]                                          | ✓                                                             | ✗                                                                    | ✗                                                                 | ✗                                                               | ✗                                                        |
| Beam search \[27]                                          | ✓                                                             | ✓                                                                    | ✓                                                                 | ✓                                                               | ✗                                                        |
| **Reflexion (ours)**                                       | ✓                                                             | ✓                                                                    | ✓                                                                 | ✓                                                               | ✓                                                        |
...
```mermaid
graph TD
  N0[Agent] --> N1[SelfReflection Self-reflection LM]
  N0[Agent] --> N2[Evaluator Evaluator LM]
  N0[Agent] --> N3[Experience Experience long-term memory]
  N0[Agent] --> N4[Actor Actor LM]
  N0[Agent] --> N5[Trajectory Trajectory short-term memory]
  N0[Agent] --> N6[Environment]
  N7[SelfReflection] --> N8[Reflective text Experience]
  N9[Trajectory] --> N10[Evaluator]
  N9[Trajectory] --> N11[Actor]
  N12[Experience] --> N11[Actor]
  N7[SelfReflection] --> N13[Internal feedback Evaluator]
  N11[Actor] --> N14[Action Environment]
  N6[Environment] --> N15[Obs / Reward Actor]
```

<u>**Algorithm 1 Reinforcement via self-reflection**</u>
...
| Trial Number | ReAct only - hallucination | ReAct only - inefficient planning | ReAct + Reflexion - hallucination | ReAct + Reflexion - inefficient planning |
| ------------ | -------------------------- | --------------------------------- | --------------------------------- | ---------------------------------------- |
| 0            | 0.32                       | 0.06                              | 0.32                              | 0.06                                     |
| 1            | 0.29                       | 0.05                              | 0.24                              | 0.02                                     |
| 2            | 0.23                       | 0.05                              | 0.16                              | 0.02                                     |
| 3            | 0.22                       | 0.04                              | 0.13                              | 0.02                                     |
| 4            | 0.21                       | 0.04                              | 0.12                              | 0.00                                     |
| 5            | 0.21                       | 0.04                              | 0.09                              | 0.00                                     |
| 6            | 0.21                       | 0.04                              | 0.08                              | 0.00                                     |
| 7            | -                          | -                                 | 0.05                              | 0.00                                     |
| 8            | -                          | -                                 | 0.04                              | 0.00                                     |
| 9            | -                          | -                                 | 0.04                              | 0.00                                     |
| 10           | -                          | -                                 | 0.03                              | 0.00                                     |
...
[11] Lam, W., Winter, S., Wei, A., Xie, T., Marinov, D., and Bell, J. (2020). A large-scale longitudinal study of flaky tests. *Italic Proc. ACM Program. Lang.*, 4(OOPSLA).

[12] Le, H., Wang, Y., Gotmare, A. D., Savarese, S., and Hoi, S. C. H. (2022). Coderl: Mastering code generation through pretrained models and deep reinforcement learning. *Italic Advances in Neural Information Processing Systems*, 35:21314–21328.
...
[14] Li, Y., Choi, D., Chung, J., Kushman, N., Schrittwieser, J., Leblond, R., Eccles, T., Keeling, J., Gimeno, F., Dal Lago, A., et al. (2022). Competition-level code generation with alphacode. *Italic Science*, 378(6624):1092–1097.

[15] Madaan, A., Tandon, N., Gupta, P., Hallinan, S., Gao, L., Wiegrefte, S., Alon, U., Dziri, N., Prabhumoye, S., Yang, Y., et al. (2023). Self-refine: Iterative refinement with self-feedback. *arXiv preprint arXiv:2303.17651*.
...
<mark> **Environment:** You are in the middle of a room. Looking quickly around you, you see a bed 1, a desk 2, a desk 1, a drawer 6, a drawer 5, a drawer 4, a drawer 3, a drawer 2, a drawer 1, a garbagecan 1, a laundryhamper 1, a safe 1, a shelf 6, a shelf 5, a shelf 4, a shelf 3, a shelf 2, and a shelf 1. </mark>

<mark> **Task:** examine the mug with the desklamp. </mark>
...
<mark>> go to desk 1</mark>
<mark>On the desk 1, you see a creditcard 3, a desklamp 1, a laptop 2, a mug 1, a pen 1, and a pencil 1.</mark>
<mark>> think: Now I find a mug (1). Next, I need to take it.</mark>
<mark>> take mug 1 from desk 1</mark>
<mark>You pick up the mug 1 from the desk 1.</mark>
...
<mark> **Reflection:** In this environment, my plan was to find a mug then find and use a desklamp. However, the task says to examine the mug with the desklamp. I should have looked for the desklamp first, then looked for the mug. I noticed that the desklamp was found on desk 1. In the next trial, I will go to desk 1, find the lamp, then look for the mug and examine it with the desklamp. </mark>

## **Trial #2**

<mark>> go to desk 1</mark>
<mark>On the desk 1, you see a creditcard 3, a desklamp 1, a laptop 2, a mug 1, a pen 1, and a pencil 1.</mark>
<mark>> think: To solve the task, I need to find and take a mug, then find and use a desklamp.</mark>
<mark>> take mug 1 from desk 1</mark>
<mark>You pick up the mug 1 from the desk 1.</mark>
> think: To solve the task, I need to find and take a mug, then find and use a desklamp.
<mark>> use desklamp 1</mark>
<mark>You turn on the desklamp 1.</mark>
<mark>**Status:** Success</mark>
...
| Trial Number | ReAct only | ReAct + Reflexion |
| ------------ | ---------- | ----------------- |
| 0.0          | 0.33       | 0.33              |
| 1.0          | 0.34       | 0.35              |
| 2.0          | 0.34       | 0.35              |
...
4       any
5     non-empty sub-array of nums.
6     Example
7     minSubArraySum([2, 3, 4, 1, 2, 4]) == 1
```
...
<mark>**Trial #1:**</mark> <mark>Question: Grown-Ups starred the actor who was best known for which role on "'Allo 'Allo!'?</mark>
...
<mark>Action 2: Search["Allo 'Allo!"]</mark>
...
<mark>Action 4: Finish[Rene Artois]</mark>
<mark>Observation 4: Answer is INCORRECT</mark>

<mark>**Reflection:**</mark> I searched the wrong title for the show, ""Allo 'Allo!"" , which resulted in no results. I should have searched the show's main character, Gorden Kaye, to find the role he was best known for in the show.

----

<mark>**Trial #2:**</mark> <mark>Question: Grown-Ups starred the actor who was best known for which role on ""Allo 'Allo!'?</mark>
...
<mark>Thought 2: The paragraph does not mention the actor who was best known for a role on ""Allo 'Allo!"". I need to search the actor's name instead.</mark>
...
<mark>Action 3: Finish[Captain Hans Geering]</mark>
<mark>Observation 3: Answer is CORRECT</mark>
...
**Trial #1:** <mark>Question: What profession does John Lanchester and Alan Dean Foster have in common?</mark>
...
<mark>Action 1: Finish[novelist and screenwriter]</mark>
<mark>Observation 1: Answer is INCORRECT</mark>
**Reflection:** <mark>My reasoning for the profession John Lanchester and Alan Dean Foster have in common failed because I incorrectly assumed that they both had the same profession. In the future, when attempting this question, I should focus on better researching the individual backgrounds of both authors to ensure that I am accurately identifying their professions. Additionally, I should consider the possibility that they may have multiple professions in common.</mark>

**Trial #2:** <mark>Question: What profession does John Lanchester and Alan Dean Foster have in common?</mark>
...
<mark>Action 1: Finish[novelist]</mark>
<mark>Observation 1: Answer is CORRECT</mark>

# **D.3 HotPotQA Chain-of-Thought (GT) + Reflexion**

<mark>Context:</mark> **Context:** <mark>The Battle of White Plains was a battle in the New York and New Jersey campaign of the American Revolutionary War fought on October 28, 1776, near White Plains, New York. Following the retreat ...</mark>

**Trial #1:** <mark>Question: What was a series of battles during the Revolutionary War, for control of New York City and the state of New Jersey, fought on October 28, 1776 near White Plains, New York?</mark>
...
<mark>Action 1: Finish[Battle of White Plains]</mark>
Observation 1: Answer is INCORRECT

**Trial #2:** <mark>Question: What was a series of battles during the Revolutionary War, for control of New York City and the state of New Jersey, fought on October 28, 1776 near White Plains, New York?</mark>
...
<mark>Action 1: Finish[The New York and New Jersey campaign]</mark>
Observation 1: Answer is CORRECT

**Reflection:** <mark>Upon reflecting on the incorrect answer I provided, I realize that I may not have provided enough context to accurately answer the question. The question asked for a series of battles, but I only provided the name of one battle. To better answer this question in the future, I will make sure to provide more context, such as the name of the campaign, which was the New York and New Jersey campaign, and the fact that it was a series of battles. Additionally, I will make sure to include the dates of the battles, as well as the locations, to ensure that my answer is comprehensive and accurate.</mark>
...
<mark> **Trial #1:** Question: Which of Jonny Craig and Pete Doherty has been a member of more bands ? </mark>
...
<mark> Action 1: Finish[Pete Doherty] </mark>
<mark> Observation 1: Answer is INCORRECT </mark>

<mark> **Trial #2:** Question: Which of Jonny Craig and Pete Doherty has been a member of more bands ? </mark>
...
<mark> Action 2: Finish[Jonny Craig] </mark>
<mark> Observation 2: Answer is CORRECT </mark>

<mark> **Reflection:** My reasoning for which musician has been a member of more bands failed because I did not take into account that Jonny Craig has been a member of more bands in the past, even though Pete Doherty is currently a member of more bands. In the future, when attempting this question, I should focus on researching the past and current bands of both musicians to ensure that I am accurately comparing their band memberships. </mark>

## D.4.2 (EPM) Chain-of-Thought (GT) + Reflexion

<mark> **Context:** Hari Bahadur Basnet is a Nepalese politician. He is the head of the Foreign Relations Department of the Rastriya Janashakti Party. Basnet holds a M.Sc. in Engineering. </mark>
<mark> A Master of Science (Latin: "Magister Scientiae" ; abbreviated MS, M.S., MSc, M.Sc., MSci, M.Sci., ScM, Sc.M., SciM or Sci.M.) is a master's degree in the field of science... </mark>

<mark> **Trial #1:** Question: The head of the Foreign Relations Department of the Rastriya Janashakti Party holds a degree that can be abbreviated MS, M.S., or ScM, in what field? </mark>

<u>(Previous trajectory)</u>
...
<mark> Action 1: Finish[Sciences, Engineering, and Medicine] </mark>
Observation 1: Answer is INCORRECT

<mark> **Trial #2:** Question: The head of the Foreign Relations Department of the Rastriya Janashakti Party holds a degree that can be abbreviated MS, M.S., or ScM, in what field? </mark>
...
<mark> Action 1: Finish[Engineering] </mark>
<mark> Observation 1: Answer is CORRECT </mark>

<mark> **Reflection:** For the first trial, I misunderstood the question. I thought the question was asking for a category of degrees, rather than a specific degree. I learned from my mistake and in the second trial, I focused more closely on the question to understand that it was asking for a specific field of study. </mark>
