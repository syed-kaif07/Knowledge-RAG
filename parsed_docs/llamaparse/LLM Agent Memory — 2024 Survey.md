...
**Zeyu Zhang<sup>1</sup>, Xiaoho Bo<sup>1</sup>, Chen Ma<sup>1</sup>, Rui Li<sup>1</sup>, Xu Chen<sup>1</sup>, Quanyu Dai<sup>2</sup>, **Jieming Zhu<sup>2</sup>, Zhenhua Dong<sup>2</sup>, Ji-Rong Wen<sup>1</sup>**
...
| Category               | Scenario                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Input/Context                                                                                                                                                                                                                                                                                                             | Output                                                                                      |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| **Role-playing**       | (Iron Man) My name is Iron Man, also known as Tony Stark. I am the founder of Stark Industries and billionaire. I have created the most advanced armor in the world, which not only protects me but also gives me incredible strength and the ability to fly.                                                                                                                                                                                                                                              | I'm Batman, the Knight of city.<br/>MAGIC IS ALL AROUND THE US.<br/>How you ever feel a dream?<br/>pareto, we must first learn to run!<br/>"I'm a Smart, and SmartFo are act"                                                                                                                                             | Role-playing                                                                                |
| **Open-world Game**    | Skills & Knowledge                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | HP, MP, SP                                                                                                                                                                                                                                                                                                                | Game items (blocks, pumpkin, etc.)                                                          |
| **Code Generation**    | Development Group                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `def bubble_sort(arr):`<br/># Traverse through all array elements for i in range(n):<br/># Last elements are already in place<br/># Traverse the array from 0 to n-1<br/># Check if the element found is greater<br/># than the next element<br/># return arr                                                             | Bubble sort can reorder a list of numbers.                                                  |
| **Social Simulation**  | I'm a compassionate physician specializing in cardiology, committed to improving patients' heart health and well-being.<br/>I'm a skilled nurse dedicated to patient care, ensuring comfort and supporting health with empathy and expertise.                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                           | Role-playing                                                                                |
| **Environment**        | Agent                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | LLM + Memory                                                                                                                                                                                                                                                                                                              |                                                                                             |
| **Recommendation**     | (Personal Preference) She often buys blue clothes. She values the cost-effectiveness of items, especially on clothes. She likes small things with light colors, such as ear pendants.                                                                                                                                                                                                                                                                                                                      | I want to buy a dress for the graduation party.<br/>You may like this blue dress. It is of good quality and great price.<br/>Great! I like this blue one. I will buy it for the party.<br/>Would you like to buy a waistband for your dress?                                                                              | (Context) She just bought a new blue dress. So she may need a white accessories to match it |
| **Personal Assistant** | Please help me to explain "LLM-based agent".<br/>A LLM-based agent is a type of artificial...<br/>In which scenarios does it have applications?<br/>Personal assistant, game, code generation, ....                                                                                                                                                                                                                                                                                                        | (Knowledge) According to the previous works, large language model based agents refer to artificial...<br/>(Context) The current topic is LLM-based agent. "It" refers to LLM-based agents in this conversation.                                                                                                           |                                                                                             |
| **Finance**            | Yesterday, the financial market underwent significant fluctuations. Equity markets initially slumped as investors responded to weak corporate earnings reports and concerns over global economic growth prospects. Bond yields declined as investors sought safer assets. However, sentiment improved in the afternoon following better-than-expected economic data from a major economy, which boosted investor confidence. As a result, stock prices recovered, and the market closed with modest gains. | The yield on the 10-year Treasury note rose by 0.2 percentage points, reaching its highest level in two years. Investors bought safer assets, leading to increased demand for government bonds. Corporate bonds experienced a decline in interest, with their yields rising by 0.15 percentage points.                    |                                                                                             |
| **Medicine**           | David, a 38-year-old male with a history of allergies and sinus infections, has a family history of diabetes and hypertension. As a smoker of about one pack a day and an occasional drinker, his lifestyle choices may contribute to his health risks. After traveling to a tropical country where mosquito-borne illnesses are prevalent, he has experienced symptoms such as mild fatigue, headache, and muscle aches for the past week.                                                                | The patient's travel history and symptoms suggest dengue fever, a mosquito-transmitted disease.<br/>For three days, I've had a fever ranging from 100.5°F to 102°F, a rash on my limbs, joint pain and swelling, especially in my hands, episodes of diarrhea, abdominal pain, and nausea, leading to a loss of appetite. |                                                                                             |
...
```mermaid
graph TD
  N0[LLMs LLMs 70-73] --> N1[FundamentalProblems Fundamental Problems]
  N2[LLMs] --> N3[Evaluation Evaluation]
  N2[LLMs] --> N4[Applications Applications]
  N2[LLMs] --> N5[Challenges Challenges]
  N6[FundamentalProblems] --> N7[SupervisedFineTuning Supervised Fine-tuning]
  N8[SupervisedFineTuning] --> N9[Zhang8 Zhang et al. 8 .]
  N6[FundamentalProblems] --> N10[Alignment Alignment]
  N11[Alignment] --> N12[Shen9Wang10Liu11 Shen et al. 9 , Wang et al. 10 , Liu et al. 11 .]
  N6[FundamentalProblems] --> N13[RetrievalAugmentation Retrieval Augmentation]
  N14[RetrievalAugmentation] --> N15[Gao12 Gao et al. 12 .]
  N6[FundamentalProblems] --> N16[KnowledgeEditing Knowledge Editing]
  N17[KnowledgeEditing] --> N18[Wang13Yao14Wang15Feng16Zhang17 Wang et al. 13 , Yao et al. 14 , Wang et al. 15 , Feng et al. 16 , Zhang et al. 17 .]
  N6[FundamentalProblems] --> N19[ToolUsage Tool Usage]
  N20[ToolUsage] --> N21[Qin18 Qin et al. 18 .]
  N6[FundamentalProblems] --> N22[LongContext Long-context]
  N23[LongContext] --> N24[Huang19Wang20Pawar21 Huang et al. 19 , Wang et al. 20 , Pawar et al. 21 .]
  N6[FundamentalProblems] --> N25[Multimodal Multimodal]
  N26[Multimodal] --> N27[Wu22Song23Caffagni24Yin25 Wu et al. 22 , Song et al. 23 , Caffagni et al. 24 , Yin et al. 25 .]
  N6[FundamentalProblems] --> N28[Efficiency Efficiency]
  N29[Efficiency] --> N30[Bai26Wan27Miao28Xu29Zhu30Xu31Wang32Park33 Bai et al. 26 , Wan et al. 27 , Miao et al. 28, 28 , Xu et al. 29 , Zhu et al. 30 , Xu and McAuley 31 , Wang et al. 32 , Park et al. 33 .]
  N31[Evaluation] --> N32[Chang34Guo35 Chang et al. 34 , Guo et al. 35 .]
  N33[Applications] --> N34[InformationProcessing Information Processing]
  N35[InformationProcessing] --> N36[Yang36Zhu37Xu38 Yang et al. 36 , Zhu et al. 37 , Xu et al. 38 .]
  N33[Applications] --> N37[SoftwareEngineering Software Engineering]
  N38[SoftwareEngineering] --> N39[Fan39Wang40Zheng41 Fan et al. 39 , Wang et al. 40 , Zheng et al. 41 .]
  N33[Applications] --> N40[Robotics Robotics]
  N41[Robotics] --> N42[Zeng42 Zeng et al. 42 .]
  N33[Applications] --> N43[AutonomousDriving Autonomous Driving]
  N44[AutonomousDriving] --> N45[Cui43Yang44 Cui et al. 43 , Yang et al. 44 .]
  N33[Applications] --> N46[Medecine Medecine]
  N47[Medecine] --> N48[He45Zhou46Wang47 He et al. 45 , Zhou et al. 46 , Wang et al. 47 .]
  N33[Applications] --> N49[Finance Finance]
  N50[Finance] --> N51[Li48 Li et al. 48 .]
  N33[Applications] --> N52[Psychology Psychology]
  N53[Psychology] --> N54[He49 He et al. 49 .]
  N33[Applications] --> N55[Recommendation Recommendation]
  N56[Recommendation] --> N57[Li50Lin51Wang52 Li et al. 50 , Lin et al. 51 , Wang et al. 52 .]
  N58[Challenges] --> N59[Hallucination Hallucination]
  N60[Hallucination] --> N61[Zhang53Huang54Rawte55Ye56Ji57Tonmoy58Jiang59 Zhang et al. 53 , Huang et al. 54 , Rawte et al. 55 , Ye et al. 56 , Ji et al. 57 , Tonmoy et al. 58 , Jiang et al. 59 .]
  N58[Challenges] --> N62[BiasFairness Bias & Fairness]
  N63[BiasFairness] --> N64[Gallegos60Kotek61Li62 Gallegos et al. 60 , Kotek et al. 61 , Li et al. 62 .]
  N58[Challenges] --> N65[Explainability Explainability]
  N66[Explainability] --> N67[Zhao63 Zhao et al. 63 .]
  N58[Challenges] --> N68[Security Security]
  N69[Security] --> N70[Yao64Shayegani65Neel66Smith67Dong68Das69 Yao et al. 64 , Shayegani et al. 65 , Neel and Chang 66 , Smith et al. 67 , Dong et al. 68 , Das et al. 69 .]
  N71[LLM-based Agent LLM-based Agent 3, 4, 77-80] --> N72[FundamentalProblems2 Fundamental Problems]
  N73[LLM-based Agent] --> N74[Evaluation2 Evaluation]
  N73[LLM-based Agent] --> N75[Applications2 Applications]
  N73[LLM-based Agent] --> N76[Challenges2 Challenges]
  N77[FundamentalProblems2] --> N78[Planning Planning]
  N79[Planning] --> N80[Huang74 Huang et al. 74 .]
  N77[FundamentalProblems2] --> N81[Memory Memory]
  N82[Memory] --> N83[OurSurvey Our Survey.]
  N77[FundamentalProblems2] --> N84[MultiAgents Multi-agents]
  N85[MultiAgents] --> N86[Guo75 Guo et al. 75 .]
  N87[Applications2] --> N88[Li76 Li et al. 76 .]
```
...
**Step 1**
I need to book flight tickets from Shanghai to Beijing on 5/1/2024, and from Beijing to Shanghai on 5/3/2024 through the online ticket office.
The order has been confirmed. Your ticket number is LG240503FN6317

**Step 2**
I acquired external knowledge from the magazine Attractions in Beijing. It shows that the Great Wall, the Summer Palace are famous. I determine the Forbidden City and the Summer Palace as the destinations.
Well done!

**Step 3**
I need to arrange the visiting order for Alice. According to the information above, I recommend visiting the Summer Palace, Forbidden City the next day.
I love this plan. Thanks!

# Task B: Recommending a movie for Alice

**Step 1**
According to my previous experiences of movie recommendation for Alice, she prefers to start watching movies at 9:00 PM, because she has finished work by then. I should ask Alice if she is available at that time.
Of course, it is a nice time!

**Step 2**
Now, I need to find some movies that Alice has marked "want to watch" on Netflix.
Alice's want to watch: Interstellar, Planet Terror and Candle in the Tomb

**Step 3**
Since Alice never watches horror movies at night, Interstellar would be more suitable for her. Now, I need to confirm with Alice about the movie.
Great! I like it!

(a)

## Combinatorial Operations in the Agent Self-evolution Process $$a_{t+1}^k = LLM\{R(P(M_{t-1}^k, W(\{a_t^k, o_t^k\})), c_{t+1}^k)\}$$

| Phase      | Task | Agent Action (a) | Observation (o) | Write (W) | Read (R) | Process (P) | Memory (M) |
| ---------- | ---- | ---------------- | --------------- | --------- | -------- | ----------- | ---------- |
| **Task A** |      |                  |                 |           |          |             |            |
| 1          |      | a₁A              | o₁A             | W         | R        | P           | M₁A        |
| 2          |      | a₂A              | o₂A             | W         | R        | P           | M₂A        |
...
**step.** For each trial, the agent can take multiple steps to form a potential solution to the task. For each task, the agent can explore multiple trials to accomplish the task [5]. Formally, at step $t$, we use $a_t$ and $o_t$ to represent the agent action and the observed environment response, respectively. Then, a $T$-length trial can be represented as $\xi_T = \{a_1, o_1, a_2, o_2, ..., o_T, a_T\}$.
...
**Memory Writing.** This operation aims to project the raw observations into the actually stored memory contents, which are more informative [7] and concise [6]. It corresponds to the first phase of the agent-environment interaction process. Given a task $T_k$, if the agent takes an action $a^k_t$ at step $t$, and the environment provides an observation $o^k_t$, then the memory writing operation can be formally represented as:

$$m^k_t = W(\{a^k_t, o^k_t\}),$$

where $W$ is a projecting function. $m^k_t$ is the finally stored memory contents, which can be either natural languages or parametric representations. In the above toy example, for task (A), the agent is supposed to remember the flight arrangement and the decision of attractions after [step 2]. For task (B), the agent should memorize the fact that Alice hopes to watch movies at 9:00 PM, after [step 1].
...
<sup>1</sup>For each task, there can be multiple trials for exploring the final solution, and all of them can be incorporated into the memory.
...
$$a_{t+1}^k = LLM\{R(P(M_{t-1}^k, W(\{a_t^k, o_t^k\})), c_{t+1}^k)\},$$
...
<sup>2</sup>https://en.wikipedia.org/wiki/Cognitive_psychology
...
| **Task A: Making a trip plan for Alice**                            | **Task B: Recommending a movie for Alice**                     |
| ------------------------------------------------------------------- | -------------------------------------------------------------- |
| Book tickets from Shanghai to Beijing                               | Ask if she is available at 9:00 am                             |
| Get external knowledge from the magazine                            | Find movies that Alice like on Netflix                         |
| Arrange the visiting order for Alice                                | Confirm with Alice about the movie                             |
| The order has been confirmed                                        | Of course, it is a nice time!                                  |
| Well Done!                                                          | Alice's want to watch list                                     |
| I love this plan. Thanks!                                           | Great! I like it!                                              |
| **Task A: Making a trip plan for Alice**                            | **Task B: Recommending a movie for Alice**                     |
| **Acquired knowledge from the magazine**<br/>**External Knowledge** | **Cross-trial Information**                                    |
| **Inside-trial Information**                                        | **Current Action**                                             |
| **Memory Sources**                                                  |                                                                |
| **Textual Memory**                                                  | **Parametric Memory**                                          |
| Full Interactions                                                   | Fine-tuning                                                    |
| Retrieved Interactions                                              | Information Infusing                                           |
|                                                                     | Knowledge Editing                                              |
|                                                                     | Information Change                                             |
|                                                                     | **Memory Forms**                                               |
| **Environment**                                                     | **Agent**                                                      |
|                                                                     | **Writing**                                                    |
|                                                                     | **Management**<br/>✓ Merging<br/>✓ Reflection<br/>✓ Forgetting |
|                                                                     | **Reading**                                                    |
| **Memory Operations**                                               |                                                                |
...
Table 3: Summarization of the memory operations. If a model does not have special designs on the memory operations, we use ◦ to label it, otherwise, it is denoted by √. × means that the memory operations are not discussed in the paper.

| Models                  | Writing | Management<br/>Merging | Management<br/>Reflection | Management<br/>Forgetting | Reading |
| ----------------------- | ------- | ---------------------- | ------------------------- | ------------------------- | ------- |
| MemoryBank \[6]         | √       | √                      | √                         | √                         | √       |
| RET-LLM \[7]            | √       | ×                      | ×                         | ×                         | √       |
| ChatDB \[96]            | √       | ×                      | √                         | ×                         | √       |
...
| -------------------------------------------------- | ------------------------ | ----------------------- |
| Memory                                             | **Subjective**           | Coherence               |
|                                                    |                          | Rationality             |
| **Direct Evaluation**                              |                          |                         |
| Memory                                             | **Objective**            | Result Correctness      |
|                                                    |                          | Reference Accuracy      |
|                                                    |                          | Time & Hardware Cost    |
| Demonstrate the effectiveness of the memory module |                          |                         |
| Memory                                             |                          | **Indirect Evaluation** |
|                                                    | Conversation             |                         |
|                                                    | Multi-source QA          |                         |
...
$$Correctness = \frac{1}{N} \sum_{i=1}^{N} I[a_i = \hat{a}_i],$$

where $N$ is the number of problems, $a_i$ represents the ground truth for the $i$-th problem, $\hat{a}_i$ means the answer given by the agent, and $I[a_i = \hat{a}_i]$ is the matching function commonly represented as

$$I[a_i = \hat{a}_i] = \begin{cases} 1 & if  a_i = \hat{a}_i, \\ 0 & if  a_i \neq \hat{a}_i. \end{cases}$$
...
| Social Simulation  | Generative Agents \[83]<br/>Lyfe Agents \[148]<br/>S³ \[2]<br/>MetaAgents \[109]<br/>WarAgent \[150]           | Recommendation  | RecAgent \[95]<br/>InteRecAgent \[108]<br/>RecMind \[102]<br/>AgentCF \[149]                                                 |
| Personal Assistant | MemoryBank \[6]<br/>RET-LLM \[7]<br/>MemoChat \[94]<br/>MemGPT \[100]<br/>MPC \[101]                           | Medicine        | Huatuo \[107]<br/>DoctorGLM \[129]<br/>Radiology-GPT \[132]<br/>Wang et al. \[151]<br/>EHRAgent \[152]<br/>ChatDoctor \[115] |
|                    | AutoGen \[153]<br/>ChatDB \[96]<br/>TiM \[97]<br/>SCM \[98]                                                    | Finance         | InvestLM \[113]<br/>TradingGPT \[154]<br/>QuantAgent \[155]<br/>FinMem \[156]<br/>Koa et al. \[157]                          |
|                    | Voyager \[99]<br/>GITM \[93]<br/>JARVIS \[159]<br/>LARP \[161]                                                 | Science         | Chemist-X \[158]<br/>ChemDFM \[160]<br/>MatChat \[162]                                                                       |
...
[94] Junru Lu, Siyu An, Mingbao Lin, Gabriele Pergola, Yulan He, Di Yin, Xing Sun, and Yun-sheng Wu. Memochat: Tuning llms to use memos for consistent long-range open-domain conversation. arXiv preprint arXiv:2308.08239, 2023.
...
[154] Yang Li, Yangyang Yu, Haohang Li, Zhi Chen, and Khaledoun Khashanah. Tradinggpt: Multi-agent system with layered memory and distinct characters for enhanced financial trading performance. *arXiv preprint arXiv:2309.03736*, 2023.
...
[156] Yangyang Yu, Haohang Li, Zhi Chen, Yuechen Jiang, Yang Li, Denghui Zhang, Rong Liu, Jordan W Suchow, and Khaledoun Khashanah. Finmem: A performance-enhanced llm trading agent with layered memory and character design. *arXiv e-prints*, pages arXiv–2311, 2023.
